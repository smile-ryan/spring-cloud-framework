...
public final class CommonUtils {
    ...
    /**
     * 将source中的属性值赋给target中属性； 如果source中的属性值不为空就进行赋值操作
     *
     * @param target 目标赋值类
     */
    public static Object copy(Object source, Object target) throws Exception {
        ...
        for (PropertyDescriptor var1 : desSf) {
            ...
            if (var1.getName().equals("class") && var1.getPropertyType().getSimpleName()
                .equals("Class")) {
                continue;
            }
            ...
            for (PropertyDescriptor var2 : desTf) {
                ...
                // 如果该属性名是class 并且类型为Class 则跳过
                if (var1.getName().equals("class") && var2.getPropertyType().getSimpleName()
                    .equals("Class")) {
                    continue;
                }
