...
import com.github.smile_ryan.spring.cloud.framework.auth.common.filter.CaptchaRequestFilter;
import com.github.smile_ryan.spring.cloud.framework.auth.common.handler.LoginFailureHandler;
...
public class AuthWebSecurityConfigAdapter extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    public AuthWebSecurityConfigAdapter(AuthUserDetailService authUserDetailService, AuthSecurityProperties properties, LoginFailureHandler loginFailureHandler, CaptchaRequestFilter captchaRequestFilter) {
