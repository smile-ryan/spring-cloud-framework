...
public class TokenStoreConfig {
    ...
    public TokenStoreConfig(AuthSecurityProperties authSecurityProperties, RedisConnectionFactory redisConnectionFactory, DataSource dataSource, ClientDetailsService clientDetailsService) {
