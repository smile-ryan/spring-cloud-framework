package com.github.smile_ryan.spring.cloud.framework.auth.common.serializer;

import com.fasterxml.jackson.core.JsonGenerator;
import com.fasterxml.jackson.databind.SerializerProvider;
import com.fasterxml.jackson.databind.ser.std.StdSerializer;
import com.github.smile_ryan.spring.cloud.framework.auth.common.exception.AuthException;
...
public class AuthExceptionJacksonSerializer extends StdSerializer<AuthException> {
    ...
    @Override
    public void serialize(AuthException value, JsonGenerator jgen, SerializerProvider serializerProvider) throws IOException {
