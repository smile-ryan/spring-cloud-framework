...
import com.github.smile_ryan.spring.cloud.framework.auth.common.util.CommonUtils;
...
public final class AuthClientDetails implements ClientDetails {
    ...
    public Set<String> getAuthorizedGrantTypes() {
        return authClientEntity.getAuthorizedGrantTypes() != null ?
                CommonUtils.transformStringToSet(authClientEntity.getAuthorizedGrantTypes(), String.class) : null;
    }

    @Override
    public Set<String> getRegisteredRedirectUri() {
        return authClientEntity.getRegisteredRedirectUri() != null ?
                CommonUtils.transformStringToSet(authClientEntity.getRegisteredRedirectUri(), String.class) : null;
    }

    @Override
    public Collection<GrantedAuthority> getAuthorities() {
        return (authClientEntity.getAuthorities() != null && authClientEntity.getAuthorities().trim().length() > 0) ?
                AuthorityUtils.commaSeparatedStringToAuthorityList(authClientEntity.getAuthorities()) : null;
    }
